...
[65, 46853,     "[FULL] キラキラだとか夢だとか ～Sing Girls～","[FULL] Sparkling Dreaming ~ Sing Girls ~",
                                                                                            "MASTER",    5,       33,   0,    0,   2800, 180, 180, "",""],
[64, 44474,     "キラキラだとか夢だとか ～Sing Girls～","Sparkling Dreaming ~ Sing Girls ~","MASTER",    5,       32,   0,    0,   1000, 180, 180, "",""],
[60, 122637,    "[FULL] メランコリック",              "[FULL] Melancholic",                 "Expert",    4,       25,   0,    0,   1175, 140, 140, "",""],
[59, 122636,    "[FULL] メランコリック",              "[FULL] Melancholic",                 "Hard",      3,       20,   0,    0,   869,  140, 140, "",""],
...
[162,130094,    "[FULL] See you! 〜それぞれの明日へ〜","[FULL] See you!",                   "Special",   5,       27,   1,    0,   2000, 190, 190, "这是我的谱面99214的完整版。","This is the full version of my 150th chart(99214)."],
[161,130086,    "[FULL] See you! 〜それぞれの明日へ〜","[FULL] See you!",                   "Expert",    4,       25,   0,    0,   1500, 190, 190, "",""],
[160,130085,    "[FULL] See you! 〜それぞれの明日へ〜","[FULL] See you!",                   "Hard",      3,       19,   0,    0,   1000, 190, 190, "",""],
[159,130084,    "[FULL] See you! 〜それぞれの明日へ〜","[FULL] See you!",                   "Normal",    2,       13,   0,    0,   500,  190, 190, "",""],
[158,130082,    "[FULL] See you! 〜それぞれの明日へ〜","[FULL] See you!",                   "Easy",      1,       7,    0,    0,   300,  190, 190, "",""],
...
[152,100753,    "Eltaw",                              "Eltaw",                              "ANOTHER",   6,       40,   1,    1,   1888, 193, 193, "",""],
...
[140,81019,     "神奈川電脳暗渠",                     "Kanagawa Cyber Culvert",             "Hard",      3,       20,   0,    0,   473,  180, 180, "",""],
...
[135,78301,     "Hardrain",                           "Hardrain",                           "Special",   5,       31,   0,    0,   1446, 60,  1080,"这个谱面只有蓝键，即使你开了节奏辅助。","This chart contains only blue taps, even if off-beat gray notes is on."],
...
[130,74534,     "你这背景太假了",                     "Your Background Is Too Fake",        "",          6,       66,   0,    4,   233,  505, 505, "整活谱",""],
...
[116,71986,     "qualia -ideaesthesia-",              "qualia -ideaesthesia-",              "Expert",    4,       25,   0,    0,   686,  144, 144, "谱师：-loadesthesia3229-","Charter: -loadesthesia3229-"],
[121,72479,     "sing sing red indigo / 靛红之歌",    "sing sing red indigo",               "Special",   5,       26,   0,    0,   691,  70,  114, "这个谱面只有蓝键（靛）和粉键（红）。"],
[120,72362,     "sing sing red indigo / 靛红之歌",    "sing sing red indigo",               "Expert",    4,       25,   0,    0,   572,  70,  114, "这个谱面只有蓝键（靛）和粉键（红）。"],
[119,72368,     "sing sing red indigo / 靛红之歌",    "sing sing red indigo",               "Hard",      3,       18,   0,    0,   370,  70,  114, "这个谱面只有蓝键（靛）和粉键（红）。"],
[118,72366,     "sing sing red indigo / 靛红之歌",    "sing sing red indigo",               "Normal",    2,       14,   0,    0,   225,  70,  114, "这个谱面只有蓝键（靛）和粉键（红）。"],
[117,72365,     "sing sing red indigo / 靛红之歌",    "sing sing red indigo",               "Easy",      1,       8,    0,    0,   114,  70,  114, "这个谱面只有蓝键（靛）和粉键（红）。"],
[48, 30759,     "デイタイム♪ （主菜单BGM）",          "BanG Dream! GBP Main Menu BGM",      "Expert",    4,       19,   0,    0,   288,  189, 189, "",""],
];
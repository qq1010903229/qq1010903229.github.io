...
function(t) {
	...
	function g(t) {
		...
		default.DEBUG_LOG && console.log("Mouse out Window."), c();
			...
			window.clearTimeout(e), e = window.setTimeout(d, 1e9), sessionStorage.setItem("SleepyTimer", e)
		}
	}
	function y(t) {
		var i = t.touches[0];
...
default = o;
	...
	default.DEBUG_LOG && console.log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, i)) this.mainMotionManager.startMotionPrio(r, e);
		...
		default.DEBUG_LOG && console.log("Start sound : " + n), window.l2da.pause(), s.play(), window.l2da=s, this.mainMotionManager.startMotionPrio(r, e)
		}
